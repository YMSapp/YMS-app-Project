			...
			<view class="vitem">
				...
				<view class="city-swiper">
					<swiper class="card-swiper" duration="500" @tap="cardSwiper">
						<swiper-item v-for="(item,index) in swiperList[index]" :key="index" class="swiper-item-box swiper-item-box1" @tap="todetail">
								...
								<view class="cu-item flex justify-between swiper-intro">
									...
									<view class="action">
										<view class="cu-tag bg-olive light">{{item.style1}}</view>
										<view class="cu-tag bg-blue light">{{item.style2}}</view>
									</view>
								</view>
						</swiper-item>
					</swiper>
